...
4. **Cross-agent cache sharing when safe.** RESOLVED 2026-04-25: NO. Keep current scopes (`agent` / `project` / `global`). Cross-project sharing is `global`; cross-agent within project is `project`. No new sharing model.
