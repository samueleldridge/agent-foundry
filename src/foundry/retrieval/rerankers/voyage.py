"""Voyage Rerank adapter (docs/25: voyage-rerank-2). Token-billed; cost from
usage.total_tokens when reported, else the defensive default applies."""
...
_PRICE_PER_1M_TOKENS = Decimal("0.05")
...
class VoyageReranker(HTTPReranker):
    def __init__(
        ...
        *,
        ...
        super().__init__(
            "voyage_rerank", model, get_client, emit=emit, agent_name=agent_name
        )
